...
def decode_mov2(reg,add):
    ...
    for i in range(len(final)):
        if reg=='05' and final[i]=='eax':
            final.pop(i-1)
            final.insert(i-1,val1)
            break
        if reg=='0D' and final[i]=='ebx':
            final.pop(i-1)
            final.insert(i-1,val1)
            break
        
        if reg=='15' and final[i]=='ecx':
            final.pop(i-1)
            final.insert(i-1,val1)
            break
        if reg=='1D' and final[i]=='edx':
            final.pop(i-1)
            final.insert(i-1,val1)
            break
...
def decode_push(sp,ad):
    temp=None
    for i in range(len(final)):
        if sp==80 and final[i]=='eax':
            stack.insert(0,final[i-1])
        if sp==81 and final[i]=='ebx':
            stack.insert(0,final[i-1])
        if sp==82 and final[i]=='ecx':
            stack.insert(0,final[i-1])
        if sp==83 and final[i]=='edx':
            stack.insert(0,final[i-1])
        if sp==84 and final[i]=='esp':
            stack.insert(0,final[i-1])
        if sp==85 and final[i]=='ebp':
            stack.insert(0,final[i-1])
        if sp==86 and final[i]=='esi':
            stack.insert(0,final[i-1])
        if sp==87 and final[i]=='edi':
            stack.insert(0,final[i-1])
